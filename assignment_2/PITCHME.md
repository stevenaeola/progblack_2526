...
# DRAFT COMP1101 Programming (Black) Summative Assessment 2 DRAFT{data-background-color=#7E317B}

---

## Term 2 Programming Exercise Outline

- Submission by 14:00 Thursday 30 April 2026
- Return after end of exam period
- Contributes 50% of module marks
- Requires ongoing engagement to get good marks: can't wait until near the deadline
...
- Cloud platforms ([AWS](https://aws.amazon.com/) / [Azure](https://azure.microsoft.com/en-gb/) / [Google](https://cloud.google.com/appengine) / [Others](https://medium.com/@csjcode/top-14-cloud-platforms-overall-comparison-market-share-d788c4b9e877)
...
- Or pick from a [list of things for first timers](https://www.firsttimersonly.com/) and [good first issues]()
- Make sure the project is 
  - active (frequent and recent commits, not many open PRs) 
  - collaborative (multiple contributors, not _too_ many)
:::
...
- In the repo you should include a README file including a link to the submission repo on GitHub 
- You should submit the entire content of the submission repo as a zip file
- This is NOT THE SAME as the repo which contains any code you have worked on: this may well be public

---

## Submission repository

- Give me (username stevenaeola) access to the submission repo on GitHub
- Allow access to the repo through Settings - Manage Access - Invite a collaborator
- If you do not allow access you will lose marks
- Note that this does not affect the access to any code you may write, which would most likely be in a public repo
